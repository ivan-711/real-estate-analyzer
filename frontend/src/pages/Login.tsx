...
export default function Login() {
  ...
  return (
    <Aurora className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center">
      <div className="w-full max-w-md px-4 py-16">
        <div className="rounded-xl border border-border bg-white p-8 shadow-sm">
          <h1 className="font-sans text-2xl font-bold text-navy">Log in</h1>
          <p className="mt-1 text-sm text-slate">
            Sign in to analyze and save deals.
          </p>
