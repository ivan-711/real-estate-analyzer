      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="h-28 animate-pulse rounded-xl bg-border"
            />
          ))}
        </div>
    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border border-border bg-white p-6 shadow-sm">
          ...
          >
            $<CountUp to={cashFlow} separator="," decimals={0} />/mo
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 font-mono text-2xl font-semibold tabular-nums text-navy">
            {summary?.average_cap_rate != null ? (
              <>
                <CountUp
                  to={summary.average_cap_rate * 100}
                  decimals={1}
                />
                %
              </>
        ...
        <div className="rounded-xl border border-border bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 font-mono text-2xl font-semibold tabular-nums text-navy">
            $<CountUp to={summary?.total_equity ?? 0} separator="," decimals={0} />
          </p>
        </div>
